  ...
  data () {
    return {
      ...
      usernameRules: [
        ...
        // Make sure usename is less then characters
        username => username.length < 10 || 'Username must be less then 10 characters'
      ],
      passwordRules: [
        password => !!password || 'Password is required',
        // Make sure password is at least 1 characters
